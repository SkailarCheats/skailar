...
export const GenerateForm = ({ user }: { user: User }) => {
	...
	const fetchBalance = async () => {
		const url = `https://keyauth.win/api/seller/?sellerkey=53d4ed15dd0506aceef5b63a40bcc83f&type=getbalance&username=${user.username}&appname=Skailar`;
	...
	const updateBalance = async (usedBalance: { day: number, week: number, month: number }) => {
		const url = `https://keyauth.win/api/seller/?sellerkey=53d4ed15dd0506aceef5b63a40bcc83f&type=setbalance&username=${user.username}&day=${usedBalance.day}&week=${usedBalance.week}&month=${usedBalance.month}&threemonth=0&sixmonth=0&lifetime=0`;
	...
	const handleSubmit = async (e: FormEvent) => {
		...
		const url = `https://keyauth.win/api/seller/?sellerkey=53d4ed15dd0506aceef5b63a40bcc83f&type=add&format=json&expiry=${expiry}&mask=***************&level=1&amount=${amount}&owner=${user.username}&character=2&note=Generated%20By%20${user.username}`;
