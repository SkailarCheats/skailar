 ...
 * It redirects the user to 'https://cdn.skailar.com/v1/assets/upload/Loader.exe' route using Next.js router when mounted.
...
const LoaderPage = () => {
    ...
    // Effect to redirect to 'https://cdn.skailar.com/v1/assets/upload/Loader.exe' route when component is mounted
    useEffect(() => {
        router.replace('https://cdn.skailar.com/v1/assets/upload/Loader.exe');
